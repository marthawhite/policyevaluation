...
#define MAT_FULL_TRAN_INV -2
#define MAT_SVD 1
#define MAT_SVD_INV 2
#define MAT_SVD_TRANS 3
#define MAT_TRI_DIAG_INV 4
#define MAT_SKET_SVD_INV 5
#define MAT_SKET_FULL 6
#define MAT_SKET_QR_INV 7
#define MAT_SKET_FULL_TWO 8
...
struct matrix_vars_t {
      ...
      // for tridiagonal approximation
      gsl_vector * diagA;
      gsl_vector * updiagA;
      gsl_vector * downdiagA;

      // for random sketch approximation
      gsl_vector * work2;
      gsl_vector * work3;
      gsl_vector * work4;
      gsl_matrix * mat_cov;
