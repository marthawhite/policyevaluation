...
const static struct{
      ...
      AlgDeallocateFcn deallocate_fcn;
            ...
            { "TD-Unit", init_linear_alg, deallocate_linear_alg},
            ...
            { "GTD", init_linear_alg, deallocate_linear_alg},
            { "TO-GTD", init_linear_alg, deallocate_linear_alg},
            ...
            { "ATD1st-TrueAC", init_matrix_alg, deallocate_matrix_alg},
            { "ATD2nd", init_matrix_alg, deallocate_matrix_alg},
            { "ATD1st", init_matrix_alg, deallocate_matrix_alg},
            { "LSTD", init_matrix_alg, deallocate_matrix_alg},
            { "LSTD-Unit", init_matrix_alg, deallocate_matrix_alg},
            { "EATD2nd", init_matrix_alg, deallocate_matrix_alg},
            { "ATD-TriDiag", init_matrix_alg, deallocate_matrix_alg},
            { "ATD-Sketch-SM", init_matrix_alg, deallocate_matrix_alg},
            { "ATD-Sketch", init_matrix_alg, deallocate_matrix_alg},
            { "ATD-Sketch-QR", init_matrix_alg, deallocate_matrix_alg},
            { "ATD-Sketch-Vec", init_matrix_alg, deallocate_matrix_alg},
            { "PLSTD", init_matrix_alg, deallocate_matrix_alg},
            { "B-Aw", init_matrix_alg, deallocate_matrix_alg},
            { "PB-Aw", init_matrix_alg, deallocate_matrix_alg},
            { "B-PAPw", init_matrix_alg, deallocate_matrix_alg},
            { "Pone-LSTD", init_matrix_alg, deallocate_matrix_alg},
            { "Pone-Acc", init_matrix_alg, deallocate_matrix_alg},
            { "Pone-ATD", init_matrix_alg, deallocate_matrix_alg}, 
            { "PPone-LSTD", init_matrix_alg, deallocate_matrix_alg},
